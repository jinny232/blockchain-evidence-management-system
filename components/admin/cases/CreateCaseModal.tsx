...
export default function CreateCaseModal({ open, onClose, onSaved }: Props) {
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5">
          <div>
            ...
            <h2 className="mt-1 text-2xl font-bold">➕ Create Case</h2>
            <p className="mt-1 text-sm text-slate-500">
              Register a new investigation case and assign an investigator.
            </p>
          </div>
        ...
        <div className="custom-scrollbar flex-1 space-y-4 overflow-y-auto px-6 py-5">
          ...
          <div>
            ...
            <datalist id="create-investigator-list">
